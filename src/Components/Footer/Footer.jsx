        ...
        <div data-aos="zoom-in" className="grid md:grid-cols-3 pb-44 pt-5">
          ...
          <div className="py-8 px-4">
           ...
           text-justify mb-3 flex items-center gap-3"
            ...
            <p>
              Lorem ipsum dolor sit a met consectetur, adipisicing elit. Alias
              fugi t optio fugiat facilis quae, tempora debitis quibus dam
              doloremque molestias cumque.
            </p>
          </div>
          {/* Footer Links */}
          <div
          ...
          >
            <div>
              <div className="py-8 px-4">
                <h1
                  className=" sm:text-xl text-xl font-bold sm:text-left
                 text-justify mb-3"
                >
                  Important Links
                </h1>
